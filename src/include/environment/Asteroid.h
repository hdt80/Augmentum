...
public:
	...
	// x - X coord in Map units
	// y - Y coord in Map units
	void shoot(float x, float y) {}

	// Simulate the Asteroid for an amount of time
	// diff - Microseconds to simulate the Asteroid for
	...
	// Occurs when this Asteroid dies
	void onDeath();
